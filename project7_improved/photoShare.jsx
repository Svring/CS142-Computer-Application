        ...
        <div className="cs142-main-topbar-buffer"/>
          <Grid item sm={3}>
            <Paper className="cs142-main-grid-item">
              <AltUserList logged_in={this.state.logged_in} />
            </Paper>
          </Grid>
          <Grid item sm={9}>
            <Paper className="cs142-main-grid-item">
              <Switch>
                <Route path="/loginregister"
                  render={ props => <AltLoginRegister {...props} changeLoggedIn={this.changeLoggedIn} changeView={this.changeView} />}
                />
                { this.state.logged_in ?
                <Route path="/users/:userId"
                  render={ props => <AltUserDetail {...props} changeView={this.changeView} /> }
                /> :
                <Redirect path='/users/:userId' to='/loginregister' />
                }
                { this.state.logged_in ?
                <Route path="/photos/:userId"
                  render ={ props => <AltUserPhotos {...props} changeView={this.changeView}/> }
                /> :
